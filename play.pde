...
void drawMap() {
  if (mapSelector == 0) {
    ...
    translate(0, 150);
    line(0, 600, 400, 600);
    line(400, 600, 400, 100);
    line(400, 100, 800 - 20, 100);
...
void handleButtonClicks() {
  ...
  if (mapSelector == 0) {
    //Spawning the waves of mobbies

    if (counter < waveNumber && waveNumber%5 == 0) { //every fifth wave


      mobs.add(new Mob(0 - counter*50, 150, 1, 0, 1, 30, 3));
      mobs.add(new Mob(0 - counter*150, 150, 0.5, 0, 2, 60, 10));
      mobs.add(new Mob(0 - counter*200, 150, 2, 0, 3, 15, 1));
  ...
  if (mapSelector == 1) {
    ...
    if (counter < waveNumber && waveNumber%5 == 0) { //every fifth wave
      ...
      mobs.add(new Mob(0 - counter*50, 600, 1, 0, 1, 30, 3));
      mobs.add(new Mob(0 - counter*150, 600, 0.5, 0, 2, 60, 10));
      mobs.add(new Mob(0 - counter*200, 600, 2, 0, 3, 15, 1));
